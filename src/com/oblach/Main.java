...
/*
  ...
  11.Предоставили строку, состоящую из русских букв разных регистров. Очистить ее от заглавных литер.
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    2*)(Математик дохуя? Щас посмотрим, как ты оптимизируешь это) Валентина прогуляла лекцию по математике.
